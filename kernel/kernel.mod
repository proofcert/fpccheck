...
syncR Debug Lambda Xi Sigma Phi Gamma (or P Q) := exists Xi',
	(orExpert Xi Xi' left  /\ spy_syncR Debug Lambda Xi' Sigma Phi Gamma P) \/
	(orExpert Xi Xi' right /\ spy_syncR Debug Lambda Xi' Sigma Phi Gamma Q) ;
...
%TODO Simplify expert interface?
