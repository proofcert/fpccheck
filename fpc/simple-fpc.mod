...
Define unfoldAsync : cert -> cert -> prop by
	...
	unfoldAsync (pair# (apply N AU SU AC SC) (apply# N AU SU AC SC Idx)) (pair# (apply N AU SU AC' SC) (apply# N AU SU AC' SC Idx)) := dec AC AC'.
...
Define unfoldSync : cert -> cert -> prop by
	...
	unfoldSync (pair# (apply N AU SU AC SC) (apply# N AU SU AC SC Idx)) (pair# (apply N AU SU AC SC') (apply# N AU SU AC SC' Idx)) := dec SC SC'.
...
%TODO Substract consumed allowances!
