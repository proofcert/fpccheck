...
#assert appendable (search (ctrl (limits z z z z _ (s z) _ _ z) _))
	null null null.

#assert appendable (search (ctrl (limits z z z z _ (s (s z)) _ _ z) _))
...
#assert eigen_unify (search (ctrl (limits z z z z _ z _ _ z) _ )).
