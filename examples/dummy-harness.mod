#include "../kernel/logic.mod".    % First-order logic syntax
#include "../kernel/cert.sig".     % Certificate declarations
#include "../fpc/dummy-fpc.mod".   % Concrete FPC (needed before kernel!)
#include "dummy-examples.sig".     % Concrete signature (needed before kernel!)
#include "../kernel/kernel.mod".   % Kernel
#include "dummy-examples.mod".     % Concrete examples
